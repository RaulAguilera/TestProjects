...
int main()
{
    ...
    integers.push_back(-3); //adds element at the end
    ...
    for (int elem : integers) //this is like foreach
    {
        total2 += elem;
    }
    ...
    iota(begin(consecutive2), end(consecutive2), 0);//populates vector with 0 to 9
    ...
    //replace value of element in vector
    ...
    *seventyseven = 7.2;
    ...
    //I can store lambdas into an auto variable
